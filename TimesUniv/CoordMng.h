...
protected:
	...
	void InitializeGui()
	{
		...
		btDelete.Create(NULL, L"Delete", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 1101, 503, 67, 28, hWnd, 1007);
		lvAsign.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_ALIGNLEFT | LVS_SHOWSELALWAYS | LVS_REPORT, 535, 32, 634, 466, hWnd, 1008);
		btClose.Create(NULL, L"Close", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 1031, 503, 67, 28, hWnd, 1009);
		lb3.Create(NULL, L"Enlist:", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 535, 14, 74, 16, hWnd, 1010);
		tbxCupo.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 70, 504, 110, 27, hWnd, 1011);
		lb4.Create(NULL, L"Quota:", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 23, 510, 45, 16, hWnd, 1012);
		ddPeriod.Create(NULL, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | CBS_DROPDOWNLIST | CBS_WINNORMALCASE, 587, 505, 136, 26, hWnd, 1013);
		lb5.Create(NULL, L"Period:", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 538, 511, 48, 16, hWnd, 1014);
		...
		ddPeriod.SetDock(DOCK_CENTER, DOCK_NONE, DOCK_NONE, DOCK_BORDER);
		lb5.SetDock(DOCK_CENTER, DOCK_NONE, DOCK_CENTER, DOCK_BORDER);
	}
	//_________________________________________________
