...
protected:
	...
	void InitializeGui()
	{
		...
		tbxPeriod.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_READONLY | ES_LEFT | ES_WINNORMALCASE, 590, 504, 346, 25, hWnd, 1012);
		...
		tbxPeriod.SetDock(DOCK_CENTER, DOCK_NONE, DOCK_BORDER, DOCK_BORDER);
