...
protected:
	...
	void InitializeGui()
	{
		...
		tbxCourse.Create(WS_EX_CLIENTEDGE, L"Course Name: ", WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_READONLY | ES_LEFT | ES_WINNORMALCASE, 48, 61, 211, 25, hWnd, 1010);
