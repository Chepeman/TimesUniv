...
protected:
	...
	void InitializeGui()
	{
		...
		gbox1.Create(WS_EX_TRANSPARENT, L"Data:", WS_CHILD | WS_VISIBLE | BS_GROUPBOX, 19, 11, 307, 284, hWnd, 1001);
		...
		ckBase.Create(NULL, L"Full Time", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_AUTOCHECKBOX | BS_LEFT | BS_VCENTER, 117, 262, 200, 26, hWnd, 1021);
